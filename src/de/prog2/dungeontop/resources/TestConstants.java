...
//        cards.add(new EntityCard(james, 6, 120, 2, 1, 0));
        ...
        cards.add(new SpellCard(testSpell2, 6, 30, 3, 1, 0));
        Spell testSpell3 = new DamageSpell(SpellValues.METEOR_SPELL_NAME,
                String.format(SpellValues.METEOR_SPELL_DESCRIPTION, SpellValues.METEOR_SPELL_RADIUS, SpellValues.METEOR_SPELL_DAMAGE),
                SpellValues.METEOR_SPELL_ASSET_ID, SpellValues.METEOR_SPELL_DAMAGE, 1);
        cards.add(new SpellCard(testSpell3, 6, 30, 3, 1, 0));
        Spell testSpell4 = new DamageSpell(SpellValues.METEOR_SPELL_NAME,
                String.format(SpellValues.METEOR_SPELL_DESCRIPTION, SpellValues.METEOR_SPELL_RADIUS, SpellValues.METEOR_SPELL_DAMAGE),
                SpellValues.METEOR_SPELL_ASSET_ID, SpellValues.METEOR_SPELL_DAMAGE, 1);
        cards.add(new SpellCard(testSpell4, 6, 30, 3, 1, 0));
        Spell testSpell5 = new DamageSpell(SpellValues.METEOR_SPELL_NAME,
                String.format(SpellValues.METEOR_SPELL_DESCRIPTION, SpellValues.METEOR_SPELL_RADIUS, SpellValues.METEOR_SPELL_DAMAGE),
                SpellValues.METEOR_SPELL_ASSET_ID, SpellValues.METEOR_SPELL_DAMAGE, 1);
        cards.add(new SpellCard(testSpell5, 6, 30, 3, 1, 0));
