...
public enum SpellEnum
{
    ...
    METEOR_SPELL_R1(new DamageSpell(SpellValues.METEOR_SPELL_NAME, "Damages the enemy unit by 2.", SpellValues.METEOR_SPELL_ASSET_ID, 20, 0)),
    METEOR_SPELL_R2(new DamageSpell(SpellValues.METEOR_SPELL_NAME, "Damages all enemy units in a radius of 1 by 3.", SpellValues.METEOR_SPELL_ASSET_ID, 30, 1)),
    METEOR_SPELL_R3(new DamageSpell(SpellValues.METEOR_SPELL_NAME, "Damages all enemy units in a radius of 1 by 4.", SpellValues.METEOR_SPELL_ASSET_ID, 40, 1));
